...
## Adjusts Marcos T Mello - Fev 2018
##
...
class DetailedProgressPlugin(octoprint.plugin.EventHandlerPlugin,
	...
	def _sanitize_current_data(self, currentData):
		...
		currentData["progress"]["printTimeLeftString"] = "Not yet"
		currentData["progress"]["ETA"] = "Not yet"
	...
	def get_settings_defaults(self):
		return dict(
			messages = [
				"{completion:.1f}%  ETL {printTimeLeft}"
				##, 
				##"ETL {printTimeLeft}" 
				##,
				##"ETA {ETA}"
				## REMOVED INFORMATION USELESS
			],
			eta_strftime = "%H %M Day %d",
